...
const GalleryElements = (props) => {
    /* --- --- --- --- ---
    | INITIAL CONFIGURATIONS
    --- --- --- --- --- --- --- --- --- --- */
    const Path      = props.gallery_id === 1
        ? '/storage/'+process.env.MIX_IMG_BANNER_DIR+'/'
        : '/storage/'+process.env.MIX_IMG_GALERIA_DIR+'/'
    const Client    = axios.create({
        'baseURL': '/cms/api/gallery-elements'
    })
    ...
    const create = () => {
        ...
        const post = async () => {
            ...
            if( active === 'images')
            {
                ...
                formData.append('gallery_id', props.gallery_id)
                ...
                <div className={`col-12 mb-1 ${active === 'videos' ? 'd-none' : ''}`}>
                    <div className="row">
                        ...
                        <div className="col-md-6 align-self-end">
                            ...
                            {
                                props.gallery_id === 1
                                    ? <small className="hint">Archivos: .jpg, .png de {process.env.MIX_IMG_BANNER_MW}px x {process.env.MIX_IMG_BANNER_MH}px</small>
                                    : <small className="hint">Archivos: .jpg, .png de {process.env.MIX_IMG_GALERIA_MW}px x {process.env.MIX_IMG_GALERIA_MH}px</small>
                            }
                        </div>
                        <div className="col-6">
